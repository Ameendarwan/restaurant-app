  ...
  return (
    <section className="bg-lightBackground flex w-full flex-col items-center gap-6 p-8 md:px-48 md:py-28 lg:flex-row">
      ...
      <div className="w-full md:text-center lg:w-1/2 lg:text-left">
        ...
        <h2 className="flex items-center justify-center gap-2 text-[28px] font-bold text-text md:text-[40px] lg:justify-start">
          Welcome to <i className="fas fa-utensils text-4xl text-primary"></i> Restoran
        </h2>
        ...
        <div className="mt-8 flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-start">
          <div className="flex flex-row items-center gap-6 border-l-4 border-primary pl-4">
