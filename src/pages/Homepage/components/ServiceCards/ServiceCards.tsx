...
const ServiceCards = () => {
  return (
    <section
      className="flex w-full flex-row flex-wrap justify-center gap-6 bg-white px-6 py-24 md:px-48 md:py-28"
      ...
      {services.map((service, index) => (
        <Card
          ...
          <CardContent className="gap-2r flex flex-col items-start gap-3.5 !py-10 transition-all duration-300">
            <i className={`${service.iconClass} text-3xl text-primary group-hover:text-white`} aria-hidden="true"></i>
